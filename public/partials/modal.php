...
<div id="ex1" class="modal">
	...
	<div class="content">
		...
		<div class="order-details">
			...
			</div> <?php //.single-item-order?>


			<line-items class="expanded">
					...
					<div class="line-items__item">
						<div class="line-items__item__label">
							...
							<a href="https://help.bitpay.com/paying-with-bitcoin/why-am-i-being-charged-an-additional-network-cost-on-my-bitpay-invoice" target="_blank">
								<img src="<?php echo plugin_dir_url( __FILE__ ) . '../assets/images/invoice-fee-question.svg' ?>">
							</a>
						</div>
			...
			</line-items> <?php //line-items?>

		</div><?php //.order-details?>
